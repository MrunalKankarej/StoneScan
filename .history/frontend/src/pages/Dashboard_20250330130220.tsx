...
// Placeholder image for chart, replace with actual chart
// Comment out the actual import until we have the image asset
...
// Use type for Grid to prevent issues
const Grid = MuiGrid;
            ...
            >
              ...
              <CardContent>
                <Box sx={{ p: 1, textAlign: 'center' }}>
                  <ChartSVG style={{ maxWidth: '100%', height: 'auto' }} />
                </Box>
